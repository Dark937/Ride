...
const LANGS = {
  en: {
    ...
    heroTitle:"Move Faster. Ride Smarter",heroSubtitle:"Powered By AI",
    heroDesc:"From quick city rides to daily commuting, Ride delivers a smooth and reliable experience powered by modern technology.",
    hiwTitle:"Every ride, engineered before it begins.",hiwSubtitle:"Book, and let the system take care of everything else.",
    step1Title:"Choose your class",step1Body:"Pick your vehicle class. The system locks in your preferences and handles the rest.",
    step2Title:"AI prepares the trip",step2Body:"Before the car arrives, AI has already solved the route, the timing, and the conditions.",
    step3Title:"Ride at a different level",step3Body:"Your driver arrives on time, in the right car, on the optimized path. No friction.",
    vehiclesTitle:"Supercars are not a side feature. They are part of the identity.",vehiclesSubtitle:"Ride is built around high-performance design, premium comfort, and unforgettable presence. This is not generic ride-hailing dressed in black. This is mobility with actual character.",
    fidTitle:"Rewards that make premium mobility worth repeating.",fidSubtitle:"The Ride Fidelity Card turns every journey into long-term value. Earn points, unlock exclusive discounts, access priority booking, and get benefits designed for frequent premium riders.",
    fidBenefit1:"Earn points on every ride",fidBenefit2:"Priority access during peak hours",fidBenefit3:"Exclusive monthly discounts",fidBenefit4:"Members-only offers and upgrades",
    fidGetCard:"Get your card",fidCardTitle:"Fidelity Card",fidCardLabel:"Ride Member",fidCardSub:"Premium Access",fidAIBenefits:"AI Benefits",fidPriorityTier:"Priority Tier",
    driverTitle:"Turn your car into something that works for you.",driverSubtitle:"Join the Ride driver network. Set your hours, choose your rides, and earn more with a platform built around performance — not just availability.",
    driverApply:"Apply to drive",driverLearn:"Learn more",
    stat1Val:"+40%",stat1Label:"Average earnings vs standard platforms",stat2Val:"Full flex",stat2Label:"No minimums, no schedules, no pressure",stat3Val:"AI dispatch",stat3Label:"Smarter routing means less dead mileage",
    footerBrandDesc:"Ride merges AI, premium service, and high-performance vehicles to redefine what urban mobility can feel like.",
    footerFeatures:"Features",footerVehicles:"Vehicles",footerPricing:"Pricing",footerRewards:"Rewards",
    footerAbout:"About",footerContact:"Contact",footerCareers:"Careers",footerPartners:"Partners",
    footerPrivacy:"Privacy Policy",footerTerms:"Terms of Service",footerCookies:"Cookies",footerLicenses:"Licenses",
    // Driver promo card
  ...
  it: {
    ...
    heroTitle:"Muoviti più veloce. Viaggia meglio.",heroSubtitle:"Powered By AI",
    heroDesc:"Dalle corse in città ai tragitti quotidiani, Ride offre un'esperienza fluida e affidabile grazie alla tecnologia moderna.",
    hiwTitle:"Ogni corsa, progettata prima che inizi.",hiwSubtitle:"Prenota e lascia che il sistema si occupi di tutto il resto.",
    step1Title:"Scegli la tua categoria",step1Body:"Seleziona la categoria di veicolo. Il sistema memorizza le tue preferenze e gestisce il resto.",
    step2Title:"L'AI prepara il viaggio",step2Body:"Prima che l'auto arrivi, l'AI ha già ottimizzato il percorso, i tempi e le condizioni.",
    step3Title:"Viaggia a un livello diverso",step3Body:"Il tuo autista arriva puntuale, con l'auto giusta, sul percorso ottimizzato. Zero attrito.",
    vehiclesTitle:"Le supercar non sono un optional. Fanno parte dell'identità.",vehiclesSubtitle:"Ride è costruita attorno al design ad alte prestazioni, al comfort premium e a una presenza indimenticabile. Non è un comune servizio di trasporto. È mobilità con carattere.",
    fidTitle:"Premi che rendono la mobilità premium una scelta ripetuta.",fidSubtitle:"La Carta Fedeltà Ride trasforma ogni viaggio in valore a lungo termine. Accumula punti, sblocca sconti esclusivi, accedi alla prenotazione prioritaria.",
    fidBenefit1:"Accumula punti ad ogni corsa",fidBenefit2:"Accesso prioritario nelle ore di punta",fidBenefit3:"Sconti mensili esclusivi",fidBenefit4:"Offerte e upgrade riservati ai membri",
    fidGetCard:"Ottieni la tua carta",fidCardTitle:"Carta Fedeltà",fidCardLabel:"Membro Ride",fidCardSub:"Accesso Premium",fidAIBenefits:"Vantaggi AI",fidPriorityTier:"Tier Prioritario",
    driverTitle:"Trasforma la tua auto in qualcosa che lavora per te.",driverSubtitle:"Unisciti alla rete di driver Ride. Scegli i tuoi orari, seleziona le corse e guadagna di più con una piattaforma pensata per le performance.",
    driverApply:"Candidati come driver",driverLearn:"Scopri di più",
    stat1Val:"€18",stat1Label:"media/ora",stat2Val:"Flex",stat2Label:"Nessun minimo, nessun obbligo di orario",stat3Val:"AI",stat3Label:"Percorsi più intelligenti, meno km a vuoto",
    footerBrandDesc:"Ride unisce AI, servizio premium e veicoli ad alte prestazioni per ridefinire la mobilità urbana.",
    footerFeatures:"Funzionalità",footerVehicles:"Veicoli",footerPricing:"Prezzi",footerRewards:"Premi",
    footerAbout:"Chi siamo",footerContact:"Contatti",footerCareers:"Lavora con noi",footerPartners:"Partner",
    footerPrivacy:"Privacy Policy",footerTerms:"Termini di Servizio",footerCookies:"Cookie",footerLicenses:"Licenze",
  ...
  fr: {
    ...
    heroTitle:"Avancez plus vite. Voyagez mieux.",heroSubtitle:"Propulsé par l'IA",
    heroDesc:"Des trajets rapides en ville aux déplacements quotidiens, Ride offre une expérience fluide et fiable grâce à la technologie moderne.",
    hiwTitle:"Chaque trajet, conçu avant de commencer.",hiwSubtitle:"Réservez et laissez le système s'occuper du reste.",
    step1Title:"Choisissez votre classe",step1Body:"Sélectionnez la catégorie de véhicule. Le système enregistre vos préférences et s'occupe du reste.",
    step2Title:"L'IA prépare le voyage",step2Body:"Avant l'arrivée du véhicule, l'IA a déjà optimisé l'itinéraire, le timing et les conditions.",
    step3Title:"Voyagez à un autre niveau",step3Body:"Votre chauffeur arrive à l'heure, dans la bonne voiture, sur l'itinéraire optimisé. Zéro friction.",
    vehiclesTitle:"Les supercars ne sont pas une option. Elles font partie de l'identité.",vehiclesSubtitle:"Ride est conçu autour du design haute performance, du confort premium et d'une présence inoubliable.",
    fidTitle:"Des récompenses qui rendent la mobilité premium mémorable.",fidSubtitle:"La Carte Fidélité Ride transforme chaque trajet en valeur à long terme. Gagnez des points, débloquez des réductions exclusives.",
    fidBenefit1:"Gagnez des points à chaque trajet",fidBenefit2:"Accès prioritaire aux heures de pointe",fidBenefit3:"Réductions exclusives chaque mois",fidBenefit4:"Offres et mises à niveau réservées aux membres",
    fidGetCard:"Obtenir ma carte",fidCardTitle:"Carte Fidélité",fidCardLabel:"Membre Ride",fidCardSub:"Accès Premium",fidAIBenefits:"Avantages IA",fidPriorityTier:"Tier Prioritaire",
    driverTitle:"Transformez votre voiture en source de revenus.",driverSubtitle:"Rejoignez le réseau de chauffeurs Ride. Choisissez vos horaires, sélectionnez vos trajets et gagnez plus.",
    driverApply:"Devenir chauffeur",driverLearn:"En savoir plus",
    stat1Val:"+40%",stat1Label:"Revenus moyens vs plateformes standard",stat2Val:"Flex",stat2Label:"Aucun minimum, aucune contrainte",stat3Val:"IA",stat3Label:"Routage intelligent, moins de km à vide",
    footerBrandDesc:"Ride combine IA, service premium et véhicules haute performance pour redéfinir la mobilité urbaine.",
    footerFeatures:"Fonctionnalités",footerVehicles:"Véhicules",footerPricing:"Tarifs",footerRewards:"Récompenses",
    footerAbout:"À propos",footerContact:"Contact",footerCareers:"Carrières",footerPartners:"Partenaires",
    footerPrivacy:"Politique de confidentialité",footerTerms:"Conditions d'utilisation",footerCookies:"Cookies",footerLicenses:"Licences",
  ...
  es: {
    ...
    heroTitle:"Muévete más rápido. Viaja mejor.",heroSubtitle:"Impulsado por IA",
    heroDesc:"Desde viajes rápidos por la ciudad hasta desplazamientos diarios, Ride ofrece una experiencia fluida y fiable.",
    hiwTitle:"Cada viaje, diseñado antes de empezar.",hiwSubtitle:"Reserva y deja que el sistema se encargue del resto.",
    step1Title:"Elige tu categoría",step1Body:"Selecciona la categoría de vehículo. El sistema guarda tus preferencias y gestiona el resto.",
    step2Title:"La IA prepara el viaje",step2Body:"Antes de que llegue el coche, la IA ya ha optimizado la ruta, el tiempo y las condiciones.",
    step3Title:"Viaja a otro nivel",step3Body:"Tu conductor llega puntual, con el coche adecuado, en la ruta optimizada. Sin fricción.",
    vehiclesTitle:"Los supercars no son un extra. Son parte de la identidad.",vehiclesSubtitle:"Ride está construido alrededor del diseño de alto rendimiento, el confort premium y una presencia inolvidable.",
    fidTitle:"Recompensas que hacen que la movilidad premium valga la pena.",fidSubtitle:"La Tarjeta Fidelidad Ride convierte cada viaje en valor a largo plazo. Acumula puntos, desbloquea descuentos exclusivos.",
    fidBenefit1:"Acumula puntos en cada viaje",fidBenefit2:"Acceso prioritario en horas pico",fidBenefit3:"Descuentos exclusivos cada mes",fidBenefit4:"Ofertas y mejoras solo para miembros",
    fidGetCard:"Obtener mi tarjeta",fidCardTitle:"Tarjeta Fidelidad",fidCardLabel:"Miembro Ride",fidCardSub:"Acceso Premium",fidAIBenefits:"Beneficios IA",fidPriorityTier:"Nivel Prioritario",
    driverTitle:"Convierte tu coche en algo que trabaje para ti.",driverSubtitle:"Únete a la red de conductores Ride. Elige tus horarios, selecciona tus viajes y gana más.",
    driverApply:"Solicitar ser conductor",driverLearn:"Saber más",
    stat1Val:"+40%",stat1Label:"Ingresos medios vs plataformas estándar",stat2Val:"Flex",stat2Label:"Sin mínimos ni horarios obligatorios",stat3Val:"IA",stat3Label:"Rutas más inteligentes, menos km en vacío",
    footerBrandDesc:"Ride combina IA, servicio premium y vehículos de alto rendimiento para redefinir la movilidad urbana.",
    footerFeatures:"Características",footerVehicles:"Vehículos",footerPricing:"Precios",footerRewards:"Recompensas",
    footerAbout:"Sobre nosotros",footerContact:"Contacto",footerCareers:"Empleo",footerPartners:"Socios",
    footerPrivacy:"Política de privacidad",footerTerms:"Términos de servicio",footerCookies:"Cookies",footerLicenses:"Licencias",
  ...
  zh: {
    ...
    heroTitle:"更快出行，更智慧乘车。",heroSubtitle:"AI 驱动",
    heroDesc:"无论是快速城市出行还是日常通勤，Ride 都能提供顺畅可靠的体验。",
    hiwTitle:"每次出行，在开始前就已规划好。",hiwSubtitle:"预订后，让系统处理一切。",
    step1Title:"选择您的车型",step1Body:"选择车辆类别。系统会记住您的偏好并处理其余事项。",
    step2Title:"AI 准备行程",step2Body:"在车辆到达之前，AI 已经优化了路线、时间和条件。",
    step3Title:"体验不同级别的出行",step3Body:"您的司机准时到达，乘坐合适的车，走优化的路线。零摩擦。",
    vehiclesTitle:"超跑不是附加功能，而是品牌身份的一部分。",vehiclesSubtitle:"Ride 围绕高性能设计、顶级舒适感和难忘存在感而打造。",
    fidTitle:"让高端出行值得一再选择的奖励。",fidSubtitle:"Ride 忠诚卡将每次旅程转化为长期价值。积分、解锁独家折扣、享受优先预订。",
    fidBenefit1:"每次出行积分",fidBenefit2:"高峰时段优先通道",fidBenefit3:"每月独家折扣",fidBenefit4:"会员专属优惠与升级",
    fidGetCard:"获取我的卡",fidCardTitle:"忠诚卡",fidCardLabel:"Ride 会员",fidCardSub:"尊享通道",fidAIBenefits:"AI 福利",fidPriorityTier:"优先级别",
    driverTitle:"让您的车为您工作。",driverSubtitle:"加入 Ride 司机网络。设定您的时间，选择您的行程，赚取更多。",
    driverApply:"申请成为司机",driverLearn:"了解更多",
    stat1Val:"+40%",stat1Label:"相比标准平台的平均收益",stat2Val:"灵活",stat2Label:"无最低要求，无日程限制",stat3Val:"AI",stat3Label:"更智能的路线规划，减少空驶里程",
    footerBrandDesc:"Ride 将 AI、顶级服务和高性能车辆融合，重新定义城市出行。",
    footerFeatures:"功能",footerVehicles:"车辆",footerPricing:"定价",footerRewards:"奖励",
    footerAbout:"关于我们",footerContact:"联系我们",footerCareers:"招聘",footerPartners:"合作伙伴",
    footerPrivacy:"隐私政策",footerTerms:"服务条款",footerCookies:"Cookie",footerLicenses:"许可证",
